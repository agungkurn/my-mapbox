package com.example.mymapbox.navigation

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import com.example.mymapbox.R
import com.example.mymapbox.databinding.ActivityNavigationBinding
...
class NavigationActivity : AppCompatActivity(), NavigationListener {
	...
	override fun onCreate(savedInstanceState: Bundle?) {
		...
		binding.navigationView.initialize(::initNavigation)
	}

	private fun initNavigation(isRunning: Boolean) {
		if (!isRunning && navigationMap == null) {
			binding.navigationView.retrieveNavigationMapboxMap()?.let {
				navigationMap = it
				...
				NavigationViewOptions.builder(this)
					...
					.also { builder ->
						binding.navigationView.startNavigation(builder.build())
					}
			}
		}
	}
